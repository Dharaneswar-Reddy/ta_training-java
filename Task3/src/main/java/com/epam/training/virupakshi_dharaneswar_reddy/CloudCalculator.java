...
public class CloudCalculator {
    ...
    public void calculateCloudCost() throws InterruptedException {
        addToEstimate.click();
    ...
    public Map<String, String> getInputValues() {
        ...
        inputValues.put("Operating System / Software", "Free: Debian, CentOS, CoreOS, Ubuntu or BYOL (Bring Your Own License)");
        inputValues.put("Provisioning model", "Regular");
        inputValues.put("Machine type", "n1-standard-8, vCPUs: 8, RAM: 30 GB");
        inputValues.put("GPU type", "NVIDIA TESLA P100");
        inputValues.put("Number of GPUs", "1");
        inputValues.put("Local SSD", "2x375 Gb");
        inputValues.put("Region", "Netherlands (europe-west4)");
        inputValues.put("Committed use discount options", "1 Year");
        return inputValues;
    }
}
